...
export default class ApiStack extends sst.Stack {
  ...
  constructor(scope, id, props) {
    ...
    const transactions = `${functionPath}/transactions`;
		const categories = `${functionPath}/categories`;
    ...
    this.api = new sst.Api(this, "Api", {
      ...
      routes: {
        ...
        "DELETE /transactions/{id}": `${transactions}/delete.main`,
				// Categories
				"POST /categories": `${categories}/create.main`,
        "PUT /categories/{id}": `${categories}/update.main`,
        "GET /categories": `${categories}/list.main`,
        "DELETE /categories/{id}": `${categories}/delete.main`,
      },
    });
