  ...
  constructor(scope, id, props) {
    ...
    this.api = new sst.Api(this, "Api", {
      ...
      routes: {
        ...
        "GET /users/{id}": "src/functions/users/get.main",
        // Transactions
        "POST /transactions": "src/functions/transactions/create.main",
        "PUT /transactions/{id}": "src/functions/transactions/update.main",
        "GET /transactions/{id}": "src/functions/transactions/get.main",
        "GET /transactions": "src/functions/transactions/list.main",
        "DELETE /transactions/{id}": "src/functions/transactions/delete.main",
      },
    });
