...
import { updateSpendingAccount } from "../../../redux/spending/spendingAccountsSlice";
import { onError } from "../../../lib/errorLib";
import LoadingSpinner from "../../../components/LoadingSpinner";
import "../style.css"

export default function SpendingAccountItem(props) {
  const dispatch = useDispatch();
  const [isSaving, setIsSaving] = useState(false);
  const { id, accountName, accountBalance } = props.spendingAccount;
